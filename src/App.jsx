  ...
  return (
    <nav style={{
      ...
      <span style={{ fontFamily: 'var(--font-display)', fontWeight: 800, fontSize: '1.2rem', letterSpacing: '-0.02em' }}>
        K<span style={{ color: 'var(--accent)' }}>.</span>
      </span>
      <div style={{ display: 'flex', gap: 32, alignItems: 'center' }}>
        ...
        <a href="https://play.google.com/store" target="_blank" rel="noopener noreferrer" style={{
          ...
          onMouseEnter={e => { e.target.style.transform = 'scale(1.05)'; e.target.style.boxShadow = '0 0 30px rgba(124,92,252,0.6)'; }}
          onMouseLeave={e => { e.target.style.transform = 'scale(1)'; e.target.style.boxShadow = '0 0 20px rgba(124,92,252,0.4)'; }}
        >Get App ↗</a>
      </div>
    </nav>
  )
  ...
  return (
    <section style={{
      ...
      <div className="reveal reveal-1" style={{
        ...
        marginBottom: 32, fontSize: '0.78rem', fontWeight: 500, color: '#a78bfa',
      ...
      {/* Main heading with gravity float */}
      ...
      <h1 className="reveal reveal-4" style={{
        ...
        That Matter<span style={{ color: 'var(--accent)' }}>.</span>
      </h1>
      ...
      <p className="reveal reveal-5" style={{
        ...
        I'm <strong style={{ color: 'var(--text)', fontWeight: 500 }}>Kaushik</strong> — a developer building apps and tools
        for real people. Creator of MotivateMe, a daily motivation app built for India.
      </p>

      <div className="reveal reveal-6" style={{ display: 'flex', gap: 16, flexWrap: 'wrap', justifyContent: 'center' }}>
        <a href="#apps" style={{
        ...
        <a href="#contact" style={{
          ...
          color: 'var(--text)', fontWeight: 400, fontSize: '0.95rem',
          transition: 'all 0.25s', background: 'rgba(255,255,255,0.04)',
        }}
          onMouseEnter={e => { e.currentTarget.style.transform = 'translateY(-3px)'; e.currentTarget.style.borderColor = 'rgba(124,92,252,0.5)'; }}
      ...
      <div style={{
        ...
        <span style={{ fontSize: '0.65rem', opacity: 0.6, fontStyle: 'normal', fontWeight: 500 }}>— MotivateMe ✨</span>
      </div>
...
function AppShowcase() {
  ...
  return (
    <section id="apps" style={{ padding: '120px 40px', maxWidth: 1200, margin: '0 auto', position: 'relative', zIndex: 1 }}>
      ...
      <div style={{
        ...
        <div>
          ...
          <h2 style={{
            ...
            Motivate<span style={{ color: 'var(--accent)' }}>Me</span>
          </h2>

          <p style={{ color: 'var(--muted)', fontSize: '1.05rem', lineHeight: 1.8, marginBottom: 32, maxWidth: 440 }}>
            Daily motivational quotes app built for India. 126 bundled quotes across 12 categories in 5 languages — Hindi, Hinglish, Marathi, Gujarati & English. Works fully offline with optional Gemini AI generation.
          </p>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16, marginBottom: 40 }}>
            {[
              ...
              <div key={label} style={{
                ...
                <div style={{ fontFamily: 'var(--font-display)', fontWeight: 800, fontSize: '2rem', color: 'var(--accent)' }}>{num}</div>
        ...
        >
          <div style={{
            width: 260, animation: 'float 5s ease-in-out infinite',
            ...
            <div style={{
              ...
              boxShadow: '0 40px 100px rgba(0,0,0,0.6), 0 0 0 1px rgba(255,255,255,0.05), inset 0 0 40px rgba(124,92,252,0.05)',
            }}>
              {/* Screen */}
              <div style={{ borderRadius: 30, overflow: 'hidden', background: '#080818' }}>
                ...
                <div style={{ padding: '4px 16px 12px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                  <div>
                    <div style={{ fontFamily: 'var(--font-display)', fontWeight: 900, fontSize: '1.1rem', color: 'white' }}>MotivateMe</div>
                ...
                <div style={{ padding: '0 12px 12px' }}>
                  <div style={{
                    ...
                    minHeight: 160, display: 'flex', flexDirection: 'column', justifyContent: 'center', gap: 8,
                    position: 'relative', overflow: 'hidden',
                  }}>
                    <div style={{ position: 'absolute', width: 100, height: 100, borderRadius: '50%', background: 'rgba(255,255,255,0.05)', top: -20, right: -20 }} />
                    <div style={{ fontSize: '0.55rem', color: 'rgba(255,255,255,0.3)', letterSpacing: 3, fontWeight: 700 }}>MOTIVATEME</div>
                    <div style={{ fontSize: '1.8rem', color: 'rgba(255,255,255,0.1)', lineHeight: 1 }}>"</div>
                    <div style={{ fontSize: '0.72rem', color: 'white', fontStyle: 'italic', lineHeight: 1.5 }}>
                      Build in silence. Let success make the noise.
                    </div>
                    <div style={{ width: 20, height: 1, background: 'rgba(255,255,255,0.25)' }} />
                    <div style={{ fontSize: '0.6rem', color: 'rgba(255,255,255,0.5)' }}>— MotivateMe</div>
                  </div>
                </div>
                {/* Buttons */}
                <div style={{ padding: '0 12px 16px', display: 'flex', gap: 8 }}>
                  <div style={{ flex: 1, height: 40, borderRadius: 12, background: 'rgba(255,255,255,0.07)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '0.65rem', color: 'rgba(255,255,255,0.5)' }}>📸 Save</div>
                  <div style={{ flex: 2, height: 40, borderRadius: 12, background: 'linear-gradient(135deg, #7C3AED, #6d28d9)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '0.68rem', color: 'white', fontWeight: 700 }}>🔄 New Quote</div>
                  <div style={{ flex: 1, height: 40, borderRadius: 12, background: 'rgba(255,255,255,0.07)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '0.65rem', color: 'rgba(255,255,255,0.5)' }}>📤 Share</div>
                </div>
              </div>
            </div>
          </div>
...
function About() {
  return (
    <section id="about" style={{ padding: '120px 40px', maxWidth: 1200, margin: '0 auto', position: 'relative', zIndex: 1 }}>
      <div style={{ display: 'flex', alignItems: 'center', gap: 16, marginBottom: 64 }}>
        <div style={{ width: 40, height: 1, background: 'var(--accent2)' }} />
        <span style={{ fontFamily: 'var(--font-display)', fontWeight: 700, fontSize: '0.75rem', letterSpacing: '0.18em', color: 'var(--accent2)' }}>ABOUT ME</span>
      </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 80, alignItems: 'start' }}>
        <div>
          <h2 style={{
            ...
            I build apps that<br /><span style={{ color: 'var(--accent2)' }}>people actually use.</span>
          </h2>
          <p style={{ color: 'var(--muted)', lineHeight: 1.9, marginBottom: 20, fontSize: '1rem' }}>
            Self-taught developer with a passion for building mobile apps and web products. I believe in shipping fast, learning from users, and iterating towards something great.
          </p>
          <p style={{ color: 'var(--muted)', lineHeight: 1.9, fontSize: '1rem' }}>
            Currently building MotivateMe — a daily motivation app designed specifically for India, supporting Hindi, Hinglish, Marathi, and Gujarati alongside English.
          </p>
        </div>
...
function Skills() {
  ...
  return (
    <section id="skills" style={{ padding: '120px 40px', maxWidth: 1200, margin: '0 auto', position: 'relative', zIndex: 1 }}>
      <div style={{ display: 'flex', alignItems: 'center', gap: 16, marginBottom: 64 }}>
      ...
      <h2 style={{
        fontFamily: 'var(--font-display)', fontWeight: 800,
        fontSize: 'clamp(2rem, 4vw, 3.5rem)', letterSpacing: '-0.03em', marginBottom: 64,
      }}>
        My Tech Stack<span style={{ color: 'var(--accent)' }}>.</span>
      </h2>
          ...
          <div key={name}>
            ...
            <div style={{ height: 4, background: 'rgba(255,255,255,0.06)', borderRadius: 2, overflow: 'hidden' }}>
              <div style={{
                ...
                animation: 'reveal-left 1.2s cubic-bezier(0.16,1,0.3,1) both',
              }} />
            </div>
          </div>
        ))}
...
function Contact() {
  return (
    <section id="contact" style={{ padding: '120px 40px 160px', maxWidth: 1200, margin: '0 auto', position: 'relative', zIndex: 1 }}>
      <div style={{ display: 'flex', alignItems: 'center', gap: 16, marginBottom: 64 }}>
        <div style={{ width: 40, height: 1, background: 'var(--accent)' }} />
      ...
      <div style={{
        ...
        <h2 style={{
          fontFamily: 'var(--font-display)', fontWeight: 800,
          fontSize: 'clamp(2.5rem, 5vw, 4rem)', letterSpacing: '-0.03em', marginBottom: 20,
          position: 'relative',
        }}>
          Let's Build<br />Something<span style={{ color: 'var(--accent)' }}> Together.</span>
        </h2>
        <p style={{ color: 'var(--muted)', fontSize: '1.05rem', maxWidth: 440, margin: '0 auto 48px', lineHeight: 1.8, position: 'relative' }}>
          Have an app idea? Want to collaborate? Or just want to say hi — I'm always open to interesting conversations.
        </p>

        <div style={{ display: 'flex', gap: 16, justifyContent: 'center', flexWrap: 'wrap', position: 'relative' }}>
          <a href="mailto:hello@kaushik.dev" style={{
            ...
            onMouseEnter={e => { e.currentTarget.style.transform = 'translateY(-3px)'; e.currentTarget.style.boxShadow = '0 0 60px rgba(124,92,252,0.6)'; }}
            onMouseLeave={e => { e.currentTarget.style.transform = 'translateY(0)'; e.currentTarget.style.boxShadow = '0 0 40px rgba(124,92,252,0.4)'; }}
          >
            ✉️ Say Hello
          </a>
          <Link to="/support" style={{
            ...
            color: 'var(--text)', fontWeight: 400, fontSize: '1rem',
            transition: 'all 0.25s',
            display: 'inline-flex', alignItems: 'center', gap: 8,
          }}
            onMouseEnter={e => { e.currentTarget.style.transform = 'translateY(-3px)'; e.currentTarget.style.borderColor = 'rgba(124,92,252,0.4)'; }}
            onMouseLeave={e => { e.currentTarget.style.transform = 'translateY(0)'; e.currentTarget.style.borderColor = 'rgba(255,255,255,0.15)'; }}
          >
            🛠 App Support
          </Link>
  ...
  return (
    <footer style={{
      ...
      <span style={{ fontSize: '0.8rem', color: 'var(--muted)' }}>
        © {new Date().getFullYear()} Kaushik · Built with React · Deployed on Vercel
      </span>
      <div style={{ display: 'flex', gap: 24 }}>
        {[
          ...
          <Link key={label} to={to} style={{
            fontSize: '0.8rem', color: 'var(--muted)', transition: 'color 0.2s',
          }}
            onMouseEnter={e => e.target.style.color = 'var(--text)'}
            onMouseLeave={e => e.target.style.color = 'var(--muted)'}
          >{label}</Link>
